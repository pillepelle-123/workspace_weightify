// This service would be used on the frontend, but here's a reference implementation

/* 
Note: For a complete implementation, the crossfade functionality would be 
...
```
  ...
  private onTrackEnded() {
    // Signal that the track has ended and next one should be played
    console.log('Track playback ended');
    this.isPlaying = false;
    // Trigger event to get next track
  }
}

// This would be used on the frontend
